    ...
    <div class="row">
        <div class="col-md-12"> 
            <div class="form-group">
                ...
                <input type="text" name="emp_nom_empresa" class="form-control" />
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="log_nom_logradouro" />
            </div>
        </div>
        <div class="col-md-6"> 
            <div class="form-group">    
                <label> CEP <span class= "required-label"> * </span> </label>
                <input type="text" class="form-control" name="log_num_cep" id="valCEP"/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text"  class="form-control" name="bai_nom_bairro" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group"> 
                <label> Número  </label>
                <input type="text" class="form-control" name="end_num_numero" />
            </div> 
        </div>
    </div>
    <div class="row">
