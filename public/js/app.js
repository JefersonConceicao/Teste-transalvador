...
var loadModal = function loadModal(url) {
  ...
  modalObject.load("".concat(url, " .modal-dialog"), function () {
...
var showMessagesValidator = function showMessagesValidator(form, errors) {
  ...
  nameInputs.forEach(function (value) {
    var elementInput = $(form).find("input[name='".concat(value, "']"));
    var divFeedack = elementInput.parent().find(".error_feedback");

    if (errors[value].length > 0) {
      errors[value].forEach(function (value) {
        divFeedack.append("<p class=\"required-label\"> ".concat(value, " </p>"));
      });
    }
...
window.Swal = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js"); //UTILS
